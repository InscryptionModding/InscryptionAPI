...
namespace APIPlugin
{
	...
	public partial class Plugin : BaseUnityPlugin
	{
		...
		private const string PluginVersion = "1.14.0.0";
		...
		private void Awake()
		{
			...
			configEnergy = Config.Bind("Energy", "Energy Refresh", true,
				"Max energy increases and energy refreshes at end of turn");
			configDrone = Config.Bind("Energy", "Energy Drone", false,
			...
			configDroneMox = Config.Bind("Mox", "Mox Drone", false,
