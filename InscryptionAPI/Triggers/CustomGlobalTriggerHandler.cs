    ...
    public static class CustomGlobalTriggerHandler
    {
        ...
        public static List<T> GetReceivers<T>(this CardTriggerHandler self, bool getFacedownReceivers = false)
        {
            ...
            if(self != null)
            {
                ...
                {
                    if (receiver != null && receiver is T && (!getFacedownReceivers || (receiver is IActivateWhenFacedown && (receiver as IActivateWhenFacedown).ShouldTriggerCustomWhenFaceDown(typeof(T)))))
                    {
